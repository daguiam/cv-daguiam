...
%\addbibresource{publications_20210131.bib}
\addbibresource{publications_20210131_2.bib}


\begin{document}
\name{Diogo Aguiam}
%\tagline{Electronics Engineer, PhD}
\tagline{Electronics Engineer, Researcher, PhD}
% \photo{2.8cm}{images/daguiam2016.jpg}
%\photo{2.8cm}{images/daguiam2018.jpg}
\photo{2.8cm}{images/daguiam2019.jpg}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
%  \email{diogo.aguiam@tecnico.ulisboa.pt}\par
  \email{diogo.aguiam@inl.int}\par
  \phone{+351 916126735}\par
  % \medskip
  % \mailaddress{Address, Street, 00000 County}
  \location{Braga, Portugal} \par

}
\socialinfo{
  \linkedin{linkedin.com/in/diogoaguiam} \par
  \homepage{diogo.aguiam.xyz} \par
...
\cvevent{Staff Researcher - Integrated Micro and Nanotechnologies}{International Iberian Nanotechnology Laboratory}{Since July 2018}{Braga, Portugal}
\begin{itemize}
% \item Microfabrication and Exploratory Nanotechnology
\item Scientific Project Manager
\item Electronic instrumentation and data processing
\item Optical deisng and modelling
\end{itemize}

\divider
\cvevent{Microwave Diagnostics Developer - Invited Researcher}{Max-Planck-Institut für Plasmaphysik}{November 2015 -- May 2018}{Garching, Germany}
\begin{itemize}
...
\cvevent{Microwave Engineer -  Reseacher}{Instituto de Plasmas e Fusão Nuclear}{February 2013 -- June 2018}{Lisbon, Portugal}
\begin{itemize}
...
\cvevent{Open Leadership Training}{Mozilla}{June 2018}{}
\begin{itemize}
\item OpenReflectometry: open source Python library for reflectometry data
\end{itemize}
\divider

\cvevent{Software Carpentry Instructor}{Software Carpentry}{February 2018}{}
\begin{itemize}
\item Teaching basic lab skills for research computing
\end{itemize}
\divider

% \cvevent{Radiation Safety}{Max-Planck-Institut für Plasmaphysik}{2015, 2016, 2017, 2018}{Garching, Germany}
% \begin{itemize}
% \item Working in a nuclear fusion research facility including in-vessel access
% \end{itemize}
% \divider
...
\printbibliography[sorting=ynt,heading=pubtype,omitnumbers=true,title={\printinfo{\faFileTextO}{Journal Articles}},type=article]
